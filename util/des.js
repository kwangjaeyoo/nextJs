  ...
  u.enc.Base64 = {
    stringify: function (d) {
      ...
      for (var q = 0; q < l; q += 3)
        for (
          var w =
              (((n[q >>> 2] >>> (24 - 8 * (q % 4))) & 255) << 16) |
              (((n[(q + 1) >>> 2] >>> (24 - 8 * ((q + 1) % 4))) & 255) << 8) |
              ((n[(q + 2) >>> 2] >>> (24 - 8 * ((q + 2) % 4))) & 255),
            v = 0;
          4 > v && q + 0.75 * v < l;
          v++
        )
...
;(function () {
  var u = CryptoJS,
    ...
    l = u.algo,
    p = (l.EvpKDF = d.extend({
      cfg: d.extend({ keySize: 4, hasher: l.MD5, iterations: 1 }),
      init: function (d) {
...
CryptoJS.lib.Cipher ||
  (function (u) {
    ...
    d.BlockCipher = v.extend({
      cfg: v.cfg.extend({ mode: b, padding: r }),
      reset: function () {
        v.reset.call(this)
        var a = this.cfg,
          c = a.iv,
    ...
    var e = (d.CipherParams = n.extend({
      ...
      b = ((l.format = {}).OpenSSL = {
        stringify: function (a) {
          ...
          a = a.salt
          return (
            a ? p.create([1398893684, 1701076831]).concat(a).concat(c) : c
          ).toString(q)
        },
        parse: function (a) {
          a = q.parse(a)
  ...
  var d = CryptoJS,
    ...
    r = (s.DES = n.extend({
      ...
      _doCryptBlock: function (e, a, c) {
        ...
        for (var d = 0; 16 > d; d++) {
          for (
            var f = c[d], n = this._lBlock, p = this._rBlock, q = 0, r = 0;
            8 > r;
            r++
          )
            q |= b[r][((p ^ f[r]) & x[r]) >>> 0]
